...
class mn(nn.Module):
    ...
    def __init__(self,
                 ...
                 kernel_size: int = 7,  # Ofcourse can test2 kernel_size
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            x_up_3 = self.up_3(x)
            # Check and align feature map sizes.
            if x_res_3.shape != x_up_3.shape:
                x_up_3 = nn.functional.interpolate(x_up_3, size=x_res_3.shape[2:], mode='bilinear', align_corners=False)
            dec_x = x_res_3 + x_up_3
...
if __name__ == '__main__':
    ...
    network = mn(
        ...
        exp_r = 2,
        kernel_size=3,  # Can test2 kernel_size
    ...
    #         exp_r=[2,3,4,4,4,4,4,3,2],         # Expansion ratio as in Swin Transformers
    #         kernel_size=3,                     # Can test2 kernel_size
    #         deep_supervision=True,             # Can be used to test2 deep supervision
    #         do_res=True,                      # Can be used to individually test2 residual connection
    #         block_counts = [2,2,2,2,2,2,2,2,2],
    #
    #     ).cuda()
